 ...
 */
@Embeddable
public class ExclusionsPK implements Serializable {
    ...
    public ExclusionsPK(String benefitservice, String planID) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ExclusionsPK)) {
            return false;
        }
        ExclusionsPK other = (ExclusionsPK) object;
    ...
    public String toString() {
        return "Entities.ExclusionsPK[ benefitservice=" + benefitservice + ", planID=" + planID + " ]";
    }
